Vue.component('sidebar_1722885105', { template: `<nav class="fixed top-0 left-0 w-fit h-full bg-gray-100 space-y-8 sm:w-80 pt-10 text-black z-20">
        ...
        <div class="py-4 px-4 w-fit border-t border-black">
          <div class="flex items-centergap-x-4">
            <div>
              ...
              <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">Track the latest transactions on the Ethereum blockchain</a>
            </div>
          </div>
        </div>
      </div>
